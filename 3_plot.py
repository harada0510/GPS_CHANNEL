...
################ WGS84座標系 ####################
b = open('data/xy_WGS84_rotated.csv','r')
x_wgs84_list = []
y_wgs84_list = []
num = 0
for i in b:
...
plt.title('Compare two csv files',fontsize=18)
plt.xlabel('X[m]',fontsize=18)
plt.ylabel('Y[m]',fontsize=18)
plt.plot(X,Y,label = "xy_rotated.csv",marker='.',linewidth = 2.0,ms=10)
plt.plot(X2,Y2,label='xy_WGS84_rotated.csv',marker='.',linewidth = 2.0,ms=10)
